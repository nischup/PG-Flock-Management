...
const form = useForm({
  ...
  batch_no: props.batchAssign.batch_no,
...
// Computed: disable submit if any required field is empty
const isSubmitDisabled = computed(() => {
  return !selectedShedReceiveId.value || !form.level || !form.batch_no
})

// Auto-calculate total quantities
watch(
  () => [form.batch_female_qty, form.batch_male_qty],
  () => {
...
watch(
  () => [form.batch_female_mortality, form.batch_male_mortality],
  () => {
...
watch(
  () => [form.batch_excess_female, form.batch_excess_male],
  () => {
    form.batch_total_excess = (form.batch_excess_female || 0) + (form.batch_excess_male || 0)
  },
  { immediate: true }
)

watch(
  () => [form.batch_sortage_female, form.batch_sortage_male],
  () => {
    form.batch_total_sortage = (form.batch_sortage_female || 0) + (form.batch_sortage_male || 0)
  },
  { immediate: true }
)
</script>
      ...
      <div class="relative">
        <div class="mb-8 flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-gray-600 dark:text-gray-400">Update batch details and quantities</p>
          </div>
        </div>

        <!-- Batch Details Card -->
        <div class="relative rounded-xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 p-6 shadow-lg dark:border-gray-600 dark:from-gray-800 dark:to-gray-900">
          <!-- Batch Header -->
          ...
          <div class="mb-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-2">
              ...
              <select v-model="form.level" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 shadow-sm transition-all duration-200 hover:border-emerald-500 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
            ...
            <div class="space-y-2">
              ...
              <select v-model="form.batch_no" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 shadow-sm transition-all duration-200 hover:border-emerald-500 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
          ...
          <div class="mb-6 rounded-xl border border-red-200 bg-gradient-to-br from-red-50 to-pink-50 p-6 dark:border-red-800 dark:from-red-900/20 dark:to-pink-900/20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div class="space-y-2">
                ...
                />
                <InputError :message="form.errors.batch_female_mortality" />
              </div>
              <div class="space-y-2">
                ...
                <Input 
                  ...
                  class="rounded-xl border-red-300 bg-red-50 px-4 py-2 text-red-800 focus:border-red-500 focus:ring-red-500/20 dark:border-red-600 dark:bg-red-900/30 dark:text-red-200" 
                />
                <InputError :message="form.errors.batch_male_mortality" />
              </div>
              <div class="space-y-2">
          ...
          <div class="mb-6 rounded-xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-green-50 p-6 dark:border-emerald-800 dark:from-emerald-900/20 dark:to-green-900/20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div class="space-y-2">
                ...
                />
                <InputError :message="form.errors.batch_excess_female" />
              </div>
              <div class="space-y-2">
          ...
          <div class="mb-6 rounded-xl border border-orange-200 bg-gradient-to-br from-orange-50 to-yellow-50 p-6 dark:border-orange-800 dark:from-orange-900/20 dark:to-yellow-900/20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div class="space-y-2">
                ...
                />
                <InputError :message="form.errors.batch_sortage_female" />
              </div>
              <div class="space-y-2">
