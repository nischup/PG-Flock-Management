                ...
                <table class="w-full border-collapse text-left">
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="border-b px-4 py-2">{{ breedType.name }}</td>
                            ...
                            <td class="border-b px-4 py-2">{{ dayjs(breedType.created_at).format('YYYY-MM-DD') }}</td>
                        ...
                        <tr v-if="breedTypes.length === 0">
                            <td colspan="5" class="border-b px-4 py-6 text-center text-gray-500">No breed types found.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
