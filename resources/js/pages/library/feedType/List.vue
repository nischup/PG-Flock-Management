            ...
            <div class="overflow-x-auto rounded-lg border border-gray-200">
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        <tr v-for="(ft, index) in feedTypes" :key="ft.id" class="odd:bg-white even:bg-gray-100 hover:bg-gray-50">
                            <td class="px-6 py-4">{{ index + 1 }}</td>
                            <td class="px-6 py-4">{{ ft.name }}</td>
                            <td class="px-6 py-4">
                        ...
                        <tr v-if="feedTypes.length === 0">
                            <td colspan="5" class="px-6 py-6 text-center text-gray-500">No feed types found.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
