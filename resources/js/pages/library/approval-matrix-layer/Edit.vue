...
const props = defineProps<{
    layer: {
        id: number;
        approval_matrix_config_id: number;
        layer_order: number;
        layer_name: string;
        role_name: string;
        is_required: number;
...
// Form
const form = useForm({
    layer_order: props.layer.layer_order,
    layer_name: props.layer.layer_name,
    role_name: props.layer.role_name,
    is_required: Boolean(props.layer.is_required),
    can_override: Boolean(props.layer.can_override),
    timeout_hours: props.layer.timeout_hours || null,
    description: props.layer.description || '',
    is_active: Boolean(props.layer.is_active),
});
...
const handleSubmit = () => {
    ...
    form.put(route('approval-matrix-layer.update', props.layer.id), {
        onSuccess: () => {
            notify('Approval matrix layer updated successfully.', 'success');
        },
        onError: (errors) => {
            console.error('Validation errors:', errors);
            notify('Failed to update approval matrix layer.', 'error');
        },
    });
};
...
<template>
    <Head title="Edit Approval Matrix Layer" />
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <HeadingSmall title="Edit Approval Matrix Layer" />
                ...
                <form @submit.prevent="handleSubmit" class="space-y-6">
                    ...
                    <div class="flex items-center justify-end gap-4 pt-6 border-t">
                        ...
                        >
                            ...
                            {{ form.processing ? 'Updating...' : 'Update Layer' }}
                        </Button>
                    </div>
                </form>
            </div>
